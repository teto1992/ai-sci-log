...
def generate_timeseries_json(
    ...
    """
    Create a synthetic dataset with 30-minute slots and write it to JSON.
    Schema matches your example:
      {
        "data_items": [
          {
            "data_id": "0000000000",
            "time": "YYYY-MM-DD::HH-MM",
            "carbon_intensities": {"time": {"London": 79, "New York": 420, ...}},
            "hardware_usages":  {"time": {"0000000000": 0.83, "0000000001": 0.30, ...}},
            "pue": 1.2,
            "functional_units": 178
          }, ...
        ]
      }
    """
